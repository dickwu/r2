...
pub async fn create_rustfs_account(
    ...
    conn.execute(
        "INSERT INTO rustfs_accounts (id, name, access_key_id, secret_access_key, endpoint_scheme, endpoint_host, force_path_style, created_at, updated_at)
...
pub(crate) async fn update_rustfs_account_on(
    ...
    let result = async {
        ...
        super::cache_scope::account_updated_on(conn, "rustfs", id).await
    }
    .await;
