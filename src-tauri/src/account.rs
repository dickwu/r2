...
pub async fn list_accounts() -> Result<Vec<db::Account>, String> {
    db::list_accounts().map_err(|e| format!("Failed to list accounts: {}", e))
}

#[tauri::command]
pub async fn create_account(id: String, name: Option<String>) -> Result<db::Account, String> {
    db::create_account(&id, name.as_deref()).map_err(|e| format!("Failed to create account: {}", e))
}

#[tauri::command]
pub async fn update_account(id: String, name: Option<String>) -> Result<(), String> {
    db::update_account(&id, name.as_deref()).map_err(|e| format!("Failed to update account: {}", e))
}

#[tauri::command]
pub async fn delete_account(id: String) -> Result<(), String> {
    db::delete_account(&id).map_err(|e| format!("Failed to delete account: {}", e))
}
...
pub async fn list_tokens(account_id: String) -> Result<Vec<db::Token>, String> {
    db::list_tokens_by_account(&account_id).map_err(|e| format!("Failed to list tokens: {}", e))
}
...
pub async fn delete_token(id: i64) -> Result<(), String> {
    db::delete_token(id).map_err(|e| format!("Failed to delete token: {}", e))
}

#[tauri::command]
pub async fn get_token(id: i64) -> Result<Option<db::Token>, String> {
    db::get_token(id).map_err(|e| format!("Failed to get token: {}", e))
}
...
pub async fn list_buckets(token_id: i64) -> Result<Vec<db::Bucket>, String> {
    db::list_buckets_by_token(token_id).map_err(|e| format!("Failed to list buckets: {}", e))
}
...
pub async fn delete_bucket(id: i64) -> Result<(), String> {
    db::delete_bucket(id).map_err(|e| format!("Failed to delete bucket: {}", e))
}
...
pub async fn get_current_config() -> Result<Option<db::CurrentConfig>, String> {
    db::get_current_config().map_err(|e| format!("Failed to get current config: {}", e))
}
...
pub async fn has_accounts() -> Result<bool, String> {
    db::has_accounts().map_err(|e| format!("Failed to check accounts: {}", e))
}
...
pub async fn get_all_accounts_with_tokens() -> Result<Vec<AccountWithTokens>, String> {
    let accounts = db::list_accounts().map_err(|e| format!("Failed to list accounts: {}", e))?;
