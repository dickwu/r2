...
pub async fn list_all_aws_objects(
    ...
    let result = aws::list_all_objects_recursive(&aws_config, Some(progress_callback))
        .await
...
pub async fn sync_aws_bucket(
    ...
    let list_result = aws::list_all_objects_recursive(&aws_config, Some(progress_callback))
        .await
